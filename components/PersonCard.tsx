...
import { hasRevenueMetrics } from '@/lib/metrics';
  ...
  return (
    <div className="bg-navy-light rounded-2xl p-5 flex flex-col gap-1 border border-white/10">
      ...
      <div className="flex items-center gap-3 mb-3">
        <div className="w-10 h-10 rounded-full bg-gold flex items-center justify-center text-navy font-black text-sm shrink-0">
          {initials}
        </div>
